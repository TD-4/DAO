...
"""
configure_nccl:设置NCCL，IB等环境变量
configure_module：设置CV2、pytorch的环境
configure_omp：TODO 解释
"""
import os
import subprocess
...
def configure_omp(num_threads=1):
    ...
    如果没有配置OMP_NUM_THREADS并且world_size大于1，
    配置NCCL的OMP_NUM_THREADS环境变量为' num_thread '。
